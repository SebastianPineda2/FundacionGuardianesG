...
<head>
    ...
    <title>Peluqueria | Fundacion Guardianes Gatunos</title>
    <!-- BOOSTRAP CSS -->
    ...
    <div class="container py-4">       
        <div class="py-4 my-4">
            <figure class=" my-3 text-centerfigure">
                <img src="img/imgcitaspeluqueria.jpg" class="figure-img img-fluid rounded" >
            </figure>            
        </div>

        <hr>
        <div class="py-4 my-4">
            <h3 class="text-center py-3">Agenda cita</h3>
            
            <form action="php/regdit_citas_insertar.php" method="post">
              <div class="form-row">
                  <div class="form-group col-md-6">
                      <label for="inputNombreMascota">Nombre de la mascota</label>
                      <input type="text" class="form-control" id="inputNombreMascota" name="nombreMascota" placeholder="Nombre completo">
                  </div>
                  <div class="form-group col-md-6">
                      <label for="inputNombrePersona">Nombre de la persona</label>
                      <input type="text" class="form-control" id="inputNombrePersona" name="nombrePersona" placeholder="Nombre completo">
                  </div>
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="inputNumeroCelular" name="celular" placeholder="Número celular">
                  </div>                  
                  <div class="form-group col-md-6">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="inputObservacion" name="observacion" placeholder="Información de la mascota">
              </div>               
              <center><button type="submit" class="btn btn-primary">Enviar</button></center>

              <div class="float-right py-4 my-6">
                <a href="listar_datos_citas.php"><button type="button" class="btn btn-danger">Siguiente</button></a>
              </div>
